static const struct HealLocation sHealLocations[] =
{
    ...
    {MAP_GROUP(LITTLEROOT_TOWN_DAWNS_HOUSE_2F), MAP_NUM(LITTLEROOT_TOWN_DAWNS_HOUSE_2F), 4, 2},
    ...
    {MAP_GROUP(FALLARBOR_TOWN), MAP_NUM(FALLARBOR_TOWN), 14, 10},
    ...
    {MAP_GROUP(SNOWSHORE), MAP_NUM(SNOWSHORE), 0, 0},
};
